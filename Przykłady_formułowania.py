print(f"xxx {10}")
# zmiana szerokości w zapisie na 8 spacji w prawą stronę
...
print(napis)
#usuwanie białych znaków specjalnych
print(napis.strip())
print(napis.lstrip())
print(napis.rstrip())
# powoduje zmianę wszystkich znaków na małe
print(napis.lower())
# powoduje zmianę wszystkich znaków na duże
print(napis.upper())
print(napis.title())
